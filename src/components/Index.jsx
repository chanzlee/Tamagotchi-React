...
class Index extends React.Component {
  constructor(props) {
    ...
    this.state = {
      gutetama: props.currentGutetama,
      image: defaultImg,
      sleepTimeout: null,
      playTimeout: null,
      poopTimeout: null,
  ...
  componentDidMount() {
    this.interval = setInterval(() => {
      ...
      if (gutetamaCopy.sleep === 0 || gutetamaCopy.play === 0 || gutetamaCopy.poop === 0 || gutetamaCopy.food === 0) {
        ...
        this.setState({ gutetama: gutetamaCopy });
      }
    }, 1000);
  }
  ...
  handleSleep() {
    ...
    this.setState({ gutetama: gutetamaCopy, image: sleep, sleepTimeout: (() => setTimeout(() => {
  ...
  handlePlay() {
    ...
    this.setState({ gutetama: gutetamaCopy, image: play, playTimeout: (() => setTimeout(() => {
      this.setState({ gutetama: gutetamaCopy, image: defaultImg });
    }, 3000))()});
  }
  ...
  handlePoop() {
    ...
    this.setState({ gutetama: gutetamaCopy, image: poop, poopTimeout: (() => setTimeout(() => {
      this.setState({ gutetama: gutetamaCopy, image: defaultImg });
    }, 3000))()});
  }
  ...
  handleFood() {
    ...
    this.setState({ gutetama: gutetamaCopy, image: food, foodTimeout: (() => setTimeout(() => {
      this.setState({ gutetama: gutetamaCopy, image: defaultImg });
    }, 3000))()});
  }
